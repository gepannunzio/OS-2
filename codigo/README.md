...
* Ejecutando `make owntest` compila y ejecuta tests escritos por nosotros que prueban más a fondo la tabla de hash y la lista atómia. Básicamente caga en paralelo una serie de archivos y luego vecifica que todas las palabras se estén insertadas correctamente. Luego incrementa una en particular y prueba el máximo en paralelo. Estos tests tardan bastante ya que se cargan archivos con muchas palabras.
